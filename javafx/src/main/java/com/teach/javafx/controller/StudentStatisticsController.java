...
public class StudentStatisticsController {
    ...
    @FXML
    private TableColumn<Map, String> leaveCountColumn;
    @FXML
    private TableColumn<Map, String> honorCountColumn;
    @FXML
    private TableColumn<Map, String> socialCountColumn;
    @FXML
    private TableColumn<Map, String> vTimeColumn;
    ...
    public void initialize() {
        ...
        socialCountColumn.setCellValueFactory(new MapValueFactory<>("socialCount"));
        vTimeColumn.setCellValueFactory(new MapValueFactory<>("vTime"));
        onQueryButtonClick();
    }
