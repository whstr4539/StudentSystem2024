 ...
 */
public class VolunteerTableController extends ToolController {
    @FXML
    ...
    @FXML
    private TableColumn<Map,Integer> timeColumn;
    @FXML
    ...
    private ArrayList<Map> volunteerList = new ArrayList();  // 学生信息列表数据
    ...
    private void onQueryButtonClick(){
        ...
        res = HttpRequestUtil.request("/api/volunteer/getVolunteerList",req); //从后台获取所有学生信息列表集合
    ...
    public void doClose(String cmd, Map<String, Object> data) {
        ...
        res = HttpRequestUtil.request("/api/volunteer/volunteerSave",req); //从后台获取所有学生信息列表集合
        if(res != null && res.getCode()== 0) {
            onQueryButtonClick();
        }
    }
